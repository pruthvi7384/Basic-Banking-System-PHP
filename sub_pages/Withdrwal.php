        ...
        if(isset($_GET["msg"])){
            ...
            if($msg_get == "msg"){
                $msg = "<div class='alert alert-success alert-dismissible fade show' role='alert'>
                    ...
                    <strong>Withdrwal Amount Is Sussesfuly Done!</strong>
            ...
            if(isset($_POST['withdrawal'])){
                ...
                if(mysqli_num_rows($sql_q) > 0){
                    ...
                    if($prev_balance > $amount){
                        $balance_added = $prev_balance - $amount;
                        ...
                        echo "<script>window.location='Withdrwal.php?type=n&msg=msg'</script>";
                    }else{
                        $msg = "<div class='alert alert-warning alert-dismissible fade show text-center' role='alert'>
                        <strong>Ooop!</strong> Account Balance Is Not Suffitiont For Withdrwal. Please Enter Less Amount !
                        <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                    </div>";
                    }
                }else{
